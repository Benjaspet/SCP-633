...
public class BindCommand implements MessageCommand {

    @Override
    public void runCommand(Member member, TextChannel channel, Message message, String[] args) {
        final GuildVoiceState selfVoiceState = channel.getGuild().getSelfMember().getVoiceState();
        ...
        message.replyFormat("I've connected to %s successfully.", authorChannel.getName()).queue();
    }
}

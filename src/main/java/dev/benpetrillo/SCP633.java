...
public final class SCP633 {

    public static CommandManager commandManager;
    public static SlashCommandManager slashCommandManager;
    public static Logger logger = LoggerFactory.getLogger(SCP633.class);

    public static void main(String[] args) {
        try {
            new SCP633(Config.get("TOKEN"));
    ...
    private SCP633(String token) throws LoginException, IllegalArgumentException, InterruptedException {
